...
//#/ start hcdo add MineGenesis 180420
void MineGenesis(CBlock genesis){
    ...
    while (UintToArith256(newhash) > hashTarget) {
    	++genesis.nNonce;
        if (genesis.nNonce == 0){
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0x00000141e01b27dfe22cc16719feb0597ccc0b1b08a0599e1c60915d426a75c4");
        ...
        genesis = CreateGenesisBlock(1532933012, 7987772, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();		
        //MineGenesis(genesis);
		
        assert(consensus.hashGenesisBlock == uint256S("0x00000141e01b27dfe22cc16719feb0597ccc0b1b08a0599e1c60915d426a75c4"));
...
//@/ end jhhong add dns seed
		...
		strFoundationAddress = "SbSwoXFiKMcctq7KVBpXvgLJfQwuxKxW9L";

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (  0, uint256S("0x00000141e01b27dfe22cc16719feb0597ccc0b1b08a0599e1c60915d426a75c4")),
            1532933012, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams() {
        ...
        consensus.BIP34Height = 0;
        consensus.BIP34Hash = uint256S("0x000006e9bbe8b736258d09fc00335de9f949f555af246e60273cd5119b4c8620");
		consensus.BIP65Height = 1; 
        consensus.BIP66Height = 1; 
        consensus.powLimit = uint256S("00000fffff000000000000000000000000000000000000000000000000000000");
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Soom: 1 day
        ...
        genesis = CreateGenesisBlock(1531903432, 1931155, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
       // MineGenesis(genesis);
		
        assert(consensus.hashGenesisBlock == uint256S("0x000006e9bbe8b736258d09fc00335de9f949f555af246e60273cd5119b4c8620"));
        assert(genesis.hashMerkleRoot == uint256S("0x47eec0209382963a4f867534b242cd795688b38471f3b85236de04f4e77d19f4"));

        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("soomdot.io",  "testnet-seed.soomdot.io"));
        //vSeeds.push_back(CDNSSeedData("gateway.io", "test.dnsseed.gateway.io"));
		...
		strFoundationAddress = "yecvfKzmTERv4qs5VPfWhpFT7GkWyN7Yzk";

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x000006e9bbe8b736258d09fc00335de9f949f555af246e60273cd5119b4c8620")),
            1531903432, // * UNIX timestamp of last checkpoint block
            0,       // * total number of transactions between genesis and last checkpoint
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0         // * estimated number of transactions per day after checkpoint
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1531713337, 58113, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
       // MineGenesis(genesis);
		
        assert(consensus.hashGenesisBlock == uint256S("0x29780b967c75108d3431de20be844969f895db823518def92c49f43d005fdc24"));
        assert(genesis.hashMerkleRoot == uint256S("0x47eec0209382963a4f867534b242cd795688b38471f3b85236de04f4e77d19f4"));
        ...
        fTestnetToBeDeprecatedFieldRPC = false;
		strFoundationAddress = "yUDFF9QWUzckb7wawPnkKTHjwoLf9LPuiV";

        nFulfilledRequestExpireTime = 5*60; // fulfilled requests expire in 5 minutes

        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x29780b967c75108d3431de20be844969f895db823518def92c49f43d005fdc24")),
            0,
            0,
            0
        };
