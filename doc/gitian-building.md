...
git clone https://github.com/soompay/soom
```
...
```bash
    ...
    From https://github.com/soompay/soom
...
[soom/gitian.sigs](https://github.com/soompay/gitian.sigs/) repository, or if that's not possible to create a pull
request.
