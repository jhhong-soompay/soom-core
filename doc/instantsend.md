...
This mechanism has been integrated into Bitcore-Node-Soom which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/soompay/insight-api-soom#web-socket-api](https://github.com/soompay/insight-api-soom#web-socket-api)
* API: [https://github.com/soompay/insight-api-soom#instantsend-transactions](https://github.com/soompay/insight-api-soom#instantsend-transactions)
